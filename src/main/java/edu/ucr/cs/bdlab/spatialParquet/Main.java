...
//        FileSystem fs = FileSystem.get(conf);
        ...
        String outputPath = "./parquet_output/" + datasetName + "_delta_" + args[2] + "_" + sortMethod + ".parquet";
...
//            }
        ...
        String results = "";
        if(operation.equals("write")) {
            results = String.format("%s,delta,%s,%s,%d,%d,%d,%d\n",
                    datasetName, args[2], args[3], totalInput, sortingTime, writingTime, outputSize);
        } else if (operation.equals("read")) {
            results = String.format("%s,delta,%s,%s,%d,%b,%d\n",
...
//    }
    ...
    private static ParquetReader<Geometry> getParquetReader(String inputPath, boolean hasFilter,
        ...
        //174236
        Operators.DoubleColumn xColumn = FilterApi.doubleColumn("part.coordinate.x");
        Operators.DoubleColumn yColumn = FilterApi.doubleColumn("part.coordinate.y");
